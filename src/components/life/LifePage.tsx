...
export default function LifePage() {
  ...
  return (
    <div>
      ...
      {/* CTA */}
      <section className="py-[80px] px-[5%] text-white text-center" style={{ background: 'linear-gradient(145deg,#2d0a2e,#4a0d3d)' }}>
        <div className="max-w-[600px] mx-auto">
          ...
          <p className="text-[16px] text-white/65 mb-8">₹1 Crore life cover. Instant policy. 99% claim settlement.</p>
